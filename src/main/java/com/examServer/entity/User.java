...
//	private String rePassword;
	...
	@Override
	public int hashCode() {
		return Objects.hash(email, enabled, firstName, id, lastName, password, phone, profile, userName, userRoles);
	}
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		...
		userRoles.forEach(r -> {set.add(new Authority(r.getRole().getRoleName()));});
		return set;
	}
